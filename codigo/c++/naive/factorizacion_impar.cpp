...
void mpz_factorizacion_impar(mpz_t rop, const mpz_t N){
    ...
    while(!mpz_divisible_p (N, solucion_fabricada)){
        ...
        //Probamos con el siguiente numero impar
		mpz_add_ui(solucion_fabricada, solucion_fabricada, 2);
    }
...
#define RESULTADOS "../../resultados_nanosecs/odd_semiprimes_results_64.csv"
